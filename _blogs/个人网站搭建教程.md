...
在这里我假设你已经拥有了github账号，创建了一个仓库，将其设置为github pages并将本仓库的所有内容复制到了你的仓库中。下面将分文件/文件夹来介绍如何修改我的仓库来添加你的个人信息。
...
在增加栏目时，我们只需要添加到collections中，并设置output为true以生成这个栏目，设置permalink为/:collection/:path/以确定其路径。

每一个栏目都可以单独设置其属性，如blogs页面的设置如下：
